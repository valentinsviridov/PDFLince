...
export const metadata = {
  ...
  icons: SHARED_ICONS,
  alternates: {
    canonical: "https://pdflince.com/it/",
    languages: {
  ...
  openGraph: {
    ...SHARED_OPEN_GRAPH,
    images: [{ url: "https://pdflince.com/og-images/og-image-it.png", width: 1409, height: 736, alt: "PDFLince - Elaborazione PDF gratuita e privata" }],
